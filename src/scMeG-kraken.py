...
cmd3 = args.kraken + " --threads " + args.threads + " --confidence" + str(args.confidence) + " --minimum-hit-groups" + args.hitgroups + " --db " + args.dbfile + " --report " + reportf + " " + fqfile + " > " + krakenoutfile
